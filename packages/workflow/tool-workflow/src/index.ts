...
- \`progress({ completed, total?, unit?, message? })\` — report structured non-terminal progress; \`degradation({ code, message, recoverable })\` — report reduced quality or coverage without failing the run.
